...
class Square extends Shape {
    ...
    render() {
        return  `${this.parameters}<rect x="0" y="0" width="300" height="200" fill="${this.shapeFill}"/><text x="150" y="125" font-size="60" text-anchor="middle" fill="${this.textColor}">${this.textContent}</text></svg>`
    };
}
