...
describe("square test", () => {
    test("test for yellow square with pink text", () => {
        ...
        shape.setShapeFill("#fadd05");
        shape.setTextContent("LL");
        shape.setTextColor("pink");
        expect(shape.render()).toEqual('<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><rect x="50" y="0" width="200" height="200" fill="#fadd05"/><text x="150" y="125" font-size="60" text-anchor="middle" fill="pink">LL</text></svg>');
    })
})